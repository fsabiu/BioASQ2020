...
def execute_list(date, logdir, dataset_path_train, dataset_path_test, tokenizer, encoder, max_len, batch_size, epochs, learning_rate, test_execution=-1, save=False, evaluation=False):
    ...
    #######
    # Training
    trained_model = run_list_training(
...
if __name__ == "__main__":
    ...
    execute_list(date, logdir, dataset_path_train,dataset_path_test, tokenizer, encoder,
